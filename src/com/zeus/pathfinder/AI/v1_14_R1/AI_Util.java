...
import com.zeus.pathfinder.AI.v1_14_R1.AI_Util;
...
public class AI_Util implements AI_Util_Main
{
	...
	{
		Class<?> cs=Class.forName("net.minecraft.server.v1_14_R1.EntityInsentient");
	...
	@Override
	public boolean addOpenDoorAI(LivingEntity e,boolean flag,int prop)  //unsupported
	{
		return false;
	}
	@Override
	...
	{
		new AI_Util().addAItoGoalSelector(e,new PathfinderGoalBreakDoor((EntityInsentient) new AI_Util().getHandle(e), null), prop);
		return true;
	}
	@Override
